...
def reserve_vehicle():
    ...
    stripe_session = stripe.checkout.Session.create(
        ...
        mode='payment',
        success_url='https://veloce-rent.onrender.com/reserve-vehicle/success?booking_id=' + str(booking.id),
        cancel_url='https://veloce-rent.onrender.com/reserve-vehicle/cancel',
        metadata={
            'user_id': session['user_id'],
