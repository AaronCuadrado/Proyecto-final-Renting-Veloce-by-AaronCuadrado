...
export const Profile = () => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await fetch("https://proyecto-final-renting-veloce-by.onrender.com/api/users/1", {
                method: "GET",
                credentials: "include",
            });
    ...
    const handlePasswordChange = async () => {
        try {
            const response = await fetch("https://proyecto-final-renting-veloce-by.onrender.com/api/users/1/update-password", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
