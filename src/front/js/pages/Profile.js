...
export const Profile = () => {
    ...
    const fetchUserData = async () => {
        try {
            const response = await fetch("https://vigilant-system-pj7pv9xx997pf97x5-3001.app.github.dev/api/users/1", {
                method: "GET",
                credentials: "include",
            });
    ...
    const handlePasswordChange = async () => {
        try {
            const response = await fetch("https://vigilant-system-pj7pv9xx997pf97x5-3001.app.github.dev/api/users/1/update-password", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
